...
class MyParameters():
    def __init__(self, ql = 4.75/3600.0, qg = 9.0 / 3600.0, D = 69.85e-3, dl = 613.8, MG = 0.016, ts = 28*1e-3, g = 9.8, ang = np.pi / 2, z = 5, L = 100, T = 300, P0 = 119*1e5):
        self.ql = ql # m³ / s
        self.qg = qg # m³ / s
        self.D = D # m
        self.dl = dl # Kg / m³
...
def calc_fn(Re):
    ...
    if Re < 2100: # Laminar
        ...
        fn = ((1) / (- 2 * np.log10((- 5.0452 / Re) * np.log10(5.8506 / (Re ** 0.8981))))) ** 2
    return fn
